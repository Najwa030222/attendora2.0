...
<style>
    ...
    .sidebar a { 
        ...
        display: block; transition: all 0.3s ease; font-weight: 500; font-size: 0.95rem;
...
<div class="sidebar shadow-lg">
    ...
    <!-- Sidebar Brand / Logo (Added padding top for mobile close button clearance) -->
    <div class="p-4 text-center border-bottom border-secondary mb-3 pt-5 pt-lg-4" style="border-color: rgba(255,255,255,0.05) !important;">
        ...
        <small class="d-block text-white" style="letter-spacing: 1px;">EMPLOYEE PORTAL</small>
    </div>
    
    <div class="mt-2 flex-grow-1">
        <a href="dashboard.php" class="<?= $current_page === 'dashboard.php' ? 'active' : '' ?>">
            <i class="bi bi-clock-fill me-3"></i> Time Clock
        </a>
        <a href="attendance.php" class="<?= $current_page === 'attendance.php' ? 'active' : '' ?>">
            <i class="bi bi-calendar2-week me-3"></i> My Attendance
        </a>
        <a href="leave.php" class="<?= $current_page === 'leave.php' ? 'active' : '' ?>">
            <i class="bi bi-envelope-paper me-3"></i> Leave Applications
        </a>
